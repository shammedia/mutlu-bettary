<template>
    <Head>
        <title>{{ trans("404 Error") }} | | Mutlu</title>
    </Head>
    <app-layout>
                    ...
                    <div class="col-12">
                        <div class="breadcrumb__content text-center">
                            <div class="breadcrumb__title-wrapper mb-15 mb-sm-10 mb-xs-5">
                                <h1 class="breadcrumb__title color-white wow fadeIn animated" data-wow-delay=".1s">{{ trans("404 Error") }}</h1>
                            </div>
                            <div class="breadcrumb__menu wow fadeIn animated" data-wow-delay=".5s">
                                <nav>
                                    <ul>
                                        <li><span><Link :href="getHomeUrl()">{{ trans("Home") }}</Link></span></li>
                                        <li class="active"><span>{{ trans("404 Error") }}</span></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="error__content">
                            <div class="error__content-media mb-40 mb-sm-35 mb-xs-30">
                                <img class="upDown-bottom" :src="asset_path + 'images/404.png'" alt="404 error">
                            </div>

                            <div class="section__title-wrapper text-center">
                                <h3 class="section__title mb-15 mb-xs-10 wow fadeIn animated" data-wow-delay=".3s">
                                    {{ trans("Sorry.... This Page Not Found") }}
                                </h3>
