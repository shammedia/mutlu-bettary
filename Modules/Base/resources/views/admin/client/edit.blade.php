...
@section('toolbar')
    ...
    @endphp
    <x-admin.breadcrumb :pageTitle="__('Edit Client')" :breadcrumbItems="$breadcrumbItems"/>
...
<x-admin-layout>
    <x-admin.create-card title="Edit Client" :formUrl="route('admin.clients.update', $client->id)">
        @method('PUT')
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <div class="image-input image-input-outline" data-kt-image-input="true"
                     style="background-image: url('{{ $client->image ? asset('storage/'.$client->image) : asset('images/default.jpg') }}')">
                    <div class="image-input-wrapper w-500px h-250px bgi-position-center"
                         style="background-size: 75%; background-image: url({{ $client->image ? asset('storage/'.$client->image) : asset('images/default.jpg') }})"></div>
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <input type="text" class="form-control form-control-solid" name="name"
                       value="{{ old('name', $client->getTranslation('name', app()->getLocale(), false)) }}"
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-9 fv-row">
                <input type="url" class="form-control form-control-solid" name="link"
                       value="{{ old('link', $client->link) }}" placeholder="{{ __('Link') }}"/>
            </div>
        </div>
    </x-admin.create-card>
</x-admin-layout>
