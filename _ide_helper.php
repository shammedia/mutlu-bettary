...
namespace Illuminate\Session {
    ...
    class Store {
         ...
         * 
         *
         * @see \Modules\Core\Providers\MacroServiceProvider::register()
         * @param bool $condition
         * @param string|null $msg
         * @param \Throwable|null $exception
         * @static 
         */
        public static function flushMessage($condition, $msg = null, $exception = null)
        {
            return \Illuminate\Session\Store::flushMessage($condition, $msg, $exception);
        }
