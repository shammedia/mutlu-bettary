            ...
            function subProductRowHtml(idx, data) {
                ...
                return `
                    <tr>
                        ...
                        <td><input type="number" class="form-control form-control-solid" name="sub_products[${idx}][price]" value="${priceVal}" placeholder="<?php echo e(__('Price ($)')); ?>"></td>
                        <td class="text-end">
...
<?php /**PATH D:\www\mutlu\Modules/Shop\resources/views/admin/product/edit.blade.php ENDPATH**/ ?>