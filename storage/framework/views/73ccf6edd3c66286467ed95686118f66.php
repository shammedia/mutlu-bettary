            ...
            function subProductRowHtml(idx, data) {
                ...
                return `
                    <tr>
                        ...
                        <td><input type="text" class="form-control form-control-solid" name="sub_products[${idx}][price]" value="${priceVal}" placeholder="<?php echo e(__('Price ($)')); ?>"></td>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    ...
                                    <td><input type="text" class="form-control form-control-solid" name="sub_products[<?php echo e($idx); ?>][price]" value="<?php echo e($sp['price'] ?? ''); ?>" placeholder="<?php echo e(__('Price ($)')); ?>"></td>
                                    <td class="text-end">
                        ...
                        <?php else: ?>
                            <tr>
                                ...
                                <td><input type="text" class="form-control form-control-solid" name="sub_products[0][price]" value="" placeholder="<?php echo e(__('Price ($)')); ?>"></td>
                                <td class="text-end">
                                    <button type="button" class="btn btn-sm btn-light-danger remove-sub-product-row"><?php echo e(__('Remove')); ?></button>
                                </td>
                            </tr>
...
<?php /**PATH D:\www\mutlu\Modules/Shop\resources/views/admin/product/create.blade.php ENDPATH**/ ?>